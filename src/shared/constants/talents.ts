...
const WARLOCK_TALENT_IDS = [
  ...
  'warlock_destruction_aftermath',
  'warlock_destruction_molten_skin',
  'warlock_destruction_cataclysm',
  'warlock_destruction_demonic_power',
  'warlock_destruction_shadowburn',
  'warlock_destruction_ruin',
  'warlock_destruction_intensity',
  'warlock_destruction_destructive_reach',
  'warlock_destruction_improved_searing_pain',
  'warlock_destruction_backlash',
  'warlock_destruction_improved_immolate',
  'warlock_destruction_devastation',
  'warlock_destruction_nether_protection',
  'warlock_destruction_emberstorm',
  'warlock_destruction_conflagrate',
  'warlock_destruction_soul_leech',
  'warlock_destruction_pyroclasm',
  'warlock_destruction_shadow_and_flame',
  'warlock_destruction_improved_soul_leech',
  'warlock_destruction_backdraft',
  'warlock_destruction_shadowfury',
  'warlock_destruction_empowered_imp',
  'warlock_destruction_fire_and_brimstone',
  'warlock_destruction_chaos_bolt',
] as const;

const WARRIOR_TALENT_IDS = [
  'warrior_arms_improved_heroic_strike',
  'warrior_arms_deflection',
  'warrior_arms_improved_rend',
  'warrior_arms_improved_charge',
  'warrior_arms_iron_will',
  'warrior_arms_tactical_mastery',
  'warrior_arms_improved_overpower',
  'warrior_arms_anger_management',
  'warrior_arms_impale',
  'warrior_arms_deep_wounds',
  'warrior_arms_two_handed_weapon_specialization',
  'warrior_arms_taste_for_blood',
  'warrior_arms_poleaxe_specialization',
  'warrior_arms_sweeping_strikes',
  'warrior_arms_mace_specialization',
  'warrior_arms_sword_specialization',
  'warrior_arms_weapon_mastery',
  'warrior_arms_improved_hamstring',
  'warrior_arms_trauma',
  'warrior_arms_second_wind',
  'warrior_arms_mortal_strike',
  'warrior_arms_strength_of_arms',
  'warrior_arms_improved_slam',
  'warrior_arms_juggernaut',
  'warrior_arms_improved_mortal_strike',
  'warrior_arms_unrelenting_assault',
  'warrior_arms_sudden_death',
  'warrior_arms_endless_rage',
  'warrior_arms_blood_frenzy',
  'warrior_arms_wrecking_crew',
  'warrior_arms_bladestorm',

  'warrior_fury_armored_to_the_teeth',
  'warrior_fury_booming_voice',
  'warrior_fury_cruelty',
  'warrior_fury_improved_demoralizing_shout',
  'warrior_fury_unbridled_wrath',
  'warrior_fury_improved_cleave',
  'warrior_fury_piercing_howl',
  'warrior_fury_blood_craze',
  'warrior_fury_commanding_presence',
  'warrior_fury_dual_wield_specialization',
  'warrior_fury_improved_execute',
  'warrior_fury_enrage',
  'warrior_fury_precision',
  'warrior_fury_death_wish',
  'warrior_fury_improved_intercept',
  'warrior_fury_improved_berserker_rage',
  'warrior_fury_flurry',
  'warrior_fury_intensify_rage',
  'warrior_fury_bloodthirst',
  'warrior_fury_improved_whirlwind',
  'warrior_fury_furious_attacks',
  'warrior_fury_improved_berserker_stance',
  'warrior_fury_heroic_fury',
  'warrior_fury_rampage',
  'warrior_fury_bloodsurge',
  'warrior_fury_unending_fury',
  'warrior_fury_titans_grip',

  'warrior_protection_improved_bloodrage',
  'warrior_protection_shield_specialization',
  'warrior_protection_improved_thunder_clap',
  'warrior_protection_incite',
  'warrior_protection_Anticipation',
  'warrior_protection_last_stand',
  'warrior_protection_improved_revenge',
  'warrior_protection_shield_mastery',
  'warrior_protection_toughness',
  'warrior_protection_improved_spell_reflection',
  'warrior_protection_improved_disarm',
  'warrior_protection_puncture',
  'warrior_protection_improved_disciplines',
  'warrior_protection_concussion_blow',
  'warrior_protection_gag_order',
  'warrior_protection_one_handed_weapon_specialization',
  'warrior_protection_improved_defensive_stance',
  'warrior_protection_vigilance',
  'warrior_protection_focused_rage',
  'warrior_protection_vitality',
  'warrior_protection_safeguard',
  'warrior_protection_warbringer',
  'warrior_protection_devastate',
  'warrior_protection_critical_block',
  'warrior_protection_sword_and_board',
  'warrior_protection_damage_shield',
  'warrior_protection_shockwave',
] as const;
